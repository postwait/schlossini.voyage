...
var RSS = require('rss'),
    ...
    showdown = require('../public/js/showdown'),
...
var makeFeed = function(voyage, trip, points, posts) {
  ...
  var feedOptions = {
    ...
    site_url: base + '/t/' + trip.url_snippet,
    feed_url: base + '/t/' + trip.url_snippet + '/feed.xml',
    ttl: 1440,
  };
  var feed = new RSS(feedOptions);
  posts.forEach(function(p) {
    p.data.html = converter.makeHtml(p.data.body);
    feed.item({
      title: p.title,
      description: p.data.html,
